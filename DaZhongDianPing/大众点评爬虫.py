    ...
    while url:
        ...
        while True:
            try:
                ...
                css_link = re.findall(r'<link rel="stylesheet" type="text/css" href="//s3plus.meituan.net/v1/(.*?)">', r.text)
                css_link_all = 'http://s3plus.meituan.net/v1/' + css_link[0]
                break
            except:
                print(url)
                print(r.text)
...
with open('e.csv','w',newline='',encoding = 'utf-8-sig')as f:
    ...
    get_shop_comment('http://www.dianping.com/shop/92149656/review_all',f_csv)
    '''
    key = ''
